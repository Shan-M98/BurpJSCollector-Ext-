...
- ✅ **Session Persistence** - Collected URLs saved in Burp project file, restored on reopen
...
- ✅ **All JS File Types** - `.js`, `.jsx`, `.mjs`, `.ts` (including `.min.js`, `.bundle.js`)
...
### File Types
- `.js` - Standard JavaScript (including `.min.js`, `.bundle.js`)
